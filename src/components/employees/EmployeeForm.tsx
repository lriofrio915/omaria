...
const EMPRESA_DATA: Record<string, { cargos: string[]; areas: string[] }> = {
  ...
  "ADWA": {
    cargos: [
      ...
      "Asistente de Producción y Video / Production and Video Assistant",
      "Asistente Ejecutiva / Executive Assistant",
      "Community Manager / Community Manager",
      "Coordinadora de Contenido / Content Coordinator",
      ...
      "Pasante de Diseño Gráfico / Graphic Design Intern",
      "Pasante de Multimedia y Producción / Multimedia and Production Intern",
      "Pasante Productora / Production Intern",
  ...
  "INCOOP": {
    cargos: [
      "Analista de Balcón de Servicios / Service Desk Analyst",
      "Analista de Crédito / Credit Analyst",
      "Analista de Cumplimiento / Compliance Analyst",
      "Analista de Tesorería / Treasury Analyst",
      "Asesora Legal / Legal Advisor",
      "Asistente de Agencia / Agency Assistant",
      "Auditor Interno / Internal Auditor",
      "Coordinador de Operaciones / Operations Coordinator",
      "Ejecutiva de Crédito / Credit Executive",
      "Ejecutivo de Captaciones / Funding Executive",
      "Ejecutivo de Crédito / Credit Executive",
      "Ejecutivo de Inversiones / Investment Executive",
      "Especialista de Estrategia de Negocios / Business Strategy Specialist",
      "Gerente Subrogante / Acting Manager",
      "Jefe de Agencia / Branch Manager",
      "Jefe de Captaciones / Funding Manager",
      "Jefe de Cobranza / Collections Manager",
      "Jefe de Crédito / Credit Manager",
      "Jefe Nacional de Negocios / National Business Manager",
      "Oficial de Cumplimiento / Compliance Officer",
      "Oficial de Riesgos / Risk Officer",
      "Oficial de Seguridad de la Información / Information Security Officer",
    ],
    areas: [
      "Administración",
